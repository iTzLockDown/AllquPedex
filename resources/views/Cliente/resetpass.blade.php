        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!!Form::model($usuario,['route'=>['resetearpass.update', $usuario->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal', 'readonly'])!!}
                    ...
                    <div class="card-footer">
                        <button class="btn btn-sm btn-primary" type="submit"  >
                            <i class="fa fa-key" ></i> Resetear Contraseña</button> &nbsp;
